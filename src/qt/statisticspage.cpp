...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "X13 POW (POS Starts Block 14400)";
    }
    ...
    {
        subsidy = "0 OrthoCoin per block";
    }
    else if(pindexBest->nHeight < 5961)
    {
        subsidy = "1 OrthoCoin per block";
    }
    else if(pindexBest->nHeight < 7200)
    {
        subsidy = "50 OrthoCoin per block";
    }
    else if(pindexBest->nHeight < 10080)
    {
        subsidy = "100 OrthoCoin per block";
    }
    else if(pindexBest->nHeight < 14400)
    {
        subsidy = "75 OrthoCoin per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " ortho" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " ortho" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " ortho");
    }
